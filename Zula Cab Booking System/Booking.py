...
def Zula_Ride(driver_lists,route_locations_cab,id,cust_lists):
    ...
    if Pick("Hail"):
        ...
        for i in driver_lists:
            if i["Rest"] == False and i["Login"] == True:
                flag = 1
                break
        ...
        if flag:
            ...
            print("\n No Taxis Currently Available or Active - (Add More Drivers or No Drivers Logged In) \n")
            return False
    else:
        print("\n Taxi Rejected By Passenger \n")
...
def nearest_cab(driver_lists,route_locations_cab,id,cust_lists):
    ...
    print(f"\n {"Name":<15} {"Age":<10} {"Location":<10} {"Fare":<10}")
